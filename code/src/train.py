...
from visualize import plot_loss, plot_acc, plot_feature_map
...
if opt.dataset == "fer2013":
    ...
    callback = [
        ...
        ModelCheckpoint(r'D:\PycharmProjects\DL\models\with_bn_fer_cnn3_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
    ...
    callback = [
        ...
        ModelCheckpoint(r'D:/PycharmProjects/DL/models/jaffe_cnn3_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
                        save_weights_only=True)]
    ...
    callback = [
            # EarlyStopping(monitor='val_loss', patience=50, verbose=True),
        #     ReduceLROnPlateau(monitor='lr', factor=0.1, patience=15, verbose=True),
        ModelCheckpoint(r'D:/PycharmProjects/DL/models/ck_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
                        save_weights_only=True)]
...
if opt.plot_history:
    plot_loss(his, opt.dataset)
    plot_acc(his, opt.dataset)
    plot_feature_map()
