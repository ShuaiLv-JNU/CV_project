...
class UI(object):
    ...
    def retranslate_ui(self, form):
        ...
        form.setWindowTitle(_translate("Form", "人脸表情识别"))
        self.label_raw_pic.setText(_translate("Form", "图片显示区域"))
        self.label_designer.setText(_translate("Form", "designed by PyQt5"))
    ...
    def open_file_browser(self):
        ...
        if file_name is not None and file_name != "":
            ...
            # emotion, possibility = predict_expression_no_re(file_name, self.model)
